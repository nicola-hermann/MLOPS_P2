...
from mlopsp2.const import glue_task_num_labels, loader_columns, task_text_field_map
...
class GLUEDataModule(L.LightningDataModule):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.text_fields = task_text_field_map[task_name]
        self.num_labels = glue_task_num_labels[task_name]
    ...
    def setup(self, stage: str):
        ...
        for split in self.dataset.keys():
            ...
            self.columns = [c for c in self.dataset[split].column_names if c in loader_columns]
